...
export const NAV_ITEMS: NavItem[] = [
  ...
  { key: "backorders", label: "Auftragsrückstand", href: "/auftragsrueckstand", roles: ["aussendienst", "admin", "superadmin"] },
...
export const ADMIN_SUB_ITEMS: NavItem[] = [
  ...
  { key: "admin_pricing", label: "Lagerverwaltung", href: "/admin/pricing", roles: ["admin", "superadmin"] },
  { key: "admin_backorders_import", label: "Auftragsrückstand · Import", href: "/admin/backorders-import", roles: ["admin", "superadmin"] },
  ...
  { key: "admin_design", label: "Seitendesign", href: "/admin/design", roles: ["admin", "superadmin"] },
];
