...
const icon =
  ...
  L.divIcon({
    className: "",
    html: hasFlyer
      ? `<div style="width:14px;height:14px;border-radius:999px;background:#2563eb;border:2px solid white;box-shadow:0 1px 6px rgba(0,0,0,.3)"></div>`
      : `<div style="width:12px;height:12px;border-radius:999px;background:#6b7280;border:2px solid white;box-shadow:0 1px 6px rgba(0,0,0,.25)"></div>`,
    iconSize: hasFlyer ? [14, 14] : [12, 12],
    iconAnchor: hasFlyer ? [7, 7] : [6, 6],
  });
      const keys = d.manufacturer_keys ?? [];
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-12">
        <Card className="md:col-span-5">
          ...
          <CardContent className="max-h-[72vh] overflow-auto">
            ...
            {visibleWithGeo.length >= 2000 ? <div className="mt-2 text-xs text-slate-500">Liste gekürzt auf 2000 (Performance).</div> : null}
          </CardContent>
        </Card>
