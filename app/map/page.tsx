                      ...
                      <div className="flex items-start justify-between gap-2">
                        <button className="text-left" onClick={() => openDealerOnMap(d.id)} type="button">
                          ...
                          <div className="mt-1 flex flex-wrap items-center gap-1">
                            <DealerListPictos manufacturerKeys={keys2} buyingGroupKey={null} size={20} maxManufacturers={3} />
                            {repNames ? <Badge tone="amber">{repNames}</Badge> : null}
                          </div>
                        </button>
                        <div className="flex flex-col items-end gap-1">
                          <div className="flex items-center gap-2">
                            {buyingGroupKey ? <Pictogram kind="buying_group" k={buyingGroupKey} size={20} /> : null}
