...
function normCountry(raw: unknown): string {
  ...
  if (s === "de" || s === "deu" || s === "ger" || s === "germany" || s === "deutschland") return "DE";
  if (s.includes("deutschland") || s.includes("germany")) return "DE";

  if (s === "at" || s === "aut" || s === "austria" || s === "österreich" || s === "oesterreich") return "AT";
  if (s.includes("österreich") || s.includes("oesterreich") || s.includes("austria")) return "AT";

  if (s === "ch" || s === "che" || s === "switzerland" || s === "schweiz") return "CH";
  if (s.includes("schweiz") || s.includes("switzerland")) return "CH";
