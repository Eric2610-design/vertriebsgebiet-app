        ...
        <div className="rounded-[18px] border border-slate-700/40 bg-slate-900/80 p-5 shadow-[0_18px_55px_rgba(0,0,0,0.35)]">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Button
                ...
                className="h-10 rounded-xl border border-slate-700/70 bg-white/5 text-xs text-slate-100 hover:bg-white/10"
              >
          ...
          <div className="mt-4 grid gap-4 lg:grid-cols-[1.1fr_1.9fr]">
            <section className="rounded-2xl border border-slate-700/40 bg-slate-900/40 p-4">
              <div className="rounded-xl border border-slate-700/50 bg-[#0b1220] p-3">
                ...
                <div className="mt-3 space-y-2">
                  <Input
                    ...
                    className="h-10 rounded-xl border border-slate-700/70 bg-[#0b1220] text-sm text-slate-100 placeholder:text-slate-500"
                  />
                  <select
                    className="w-full rounded-xl border border-slate-700/70 bg-[#0b1220] px-3 py-2 text-sm text-slate-100"
                  ...
                  <Button
                    ...
                    disabled={!selectedDealer || dealerLoading}
                  >
              ...
              {showHelp && (
                <div className="mt-3 rounded-xl border border-slate-700/50 bg-[#0b1220] p-3 text-xs text-slate-300">
                  <div className="font-semibold text-slate-100">So testest du es schnell:</div>
