...
type ZipGroup = { zip: string; dealers: D[]; suggested_master_id: string };

type GeoGroup = { key: string; zip: string; min_distance_m: number; dealers: D[]; suggested_master_id: string };
