      ...
      <div className="flex items-center justify-between gap-3">
        <div>
          <div className="flex items-center gap-3">
            ...
            {dealer.buying_group ? (
              <div className="ml-auto inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1">
                <Pictogram
                  kind="buying_group"
                  ...
                  size={18}
                />
                <span className="text-sm text-slate-700">{dealer.buying_group.label}</span>
              </div>
            ) : null}
          </div>
        ...
        <div className="flex gap-2">
          ...
          <Link href="/buying-groups"><Button variant="secondary">Einkaufsverbände</Button></Link>
